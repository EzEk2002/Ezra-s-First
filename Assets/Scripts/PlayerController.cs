...
public class PlayerController : MonoBehaviour {
    ...
    private float collider_radius = 0.05F;
    public float grounded_epsilon = 0.05F;
    public int user_layer_platform;
    private float get_axis_horizontal = 0.00F;
    ...
    void Start()
    {
        ...
        // Connect to our collider and get the radius
    ...
    // isGrounded - will return true if we are on a platform
